...
#End Region
    ...
    Sub F_chk()
        ...
        '店舗コード
        If strDATA(28) = Nothing Then
            Err_F = "1" : Err_code = "281" : Exit Sub
        Else
            WK_DtView1 = New DataView(DsList0.Tables("Shop_mtr"), "shop_code = '" & strDATA(28) & "'", "", DataViewRowState.CurrentRows)
            If WK_DtView1.Count = 0 Then
        ...
        '料金区分
        If strDATA(29) = Nothing Then
            Err_F = "1" : Err_code = "291" : Exit Sub
        Else
            WK_DtView1 = New DataView(DsList0.Tables("fee_mtr"), "fee_kbn = '" & Trim(strDATA(29)) & "'", "", DataViewRowState.CurrentRows)
            If WK_DtView1.Count = 0 Then
                Err_F = "1" : Err_code = "183" : Exit Sub
            Else
                WK_fee_kbn = Trim(strDATA(29))
            End If
        End If
